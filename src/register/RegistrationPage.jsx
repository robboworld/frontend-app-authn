...
import { EmailField, NameField, PhoneField, UsernameField } from './RegistrationFields';
import {
...
const RegistrationPage = (props) => {
  ...
  const handlePhoneFieldBlur = (name, value) => {
  ...
  const handlePhoneFieldFocus = (name) => {
    dismissRegistrationFailureBanner();
    if (registrationEmbedded) {
      setTemporaryErrors((prev) => ({ ...prev, [name]: '' }));
    } else {
          ...
          >
            ...
            <Form id="registration-form" name="registration-form" onSubmit={handleSubmit}>
              ...
              {phoneFieldData && (
                <PhoneField
                  name="phone_number"
                  label={phoneFieldData.label}
                  helpText={phoneFieldData.helpText}
