...
import {
  ...
  normalizeUsernameServerErrorMessage,
...
const RegistrationPage = (props) => {
  ...
  const companyFieldRequired = Boolean(companyFieldData?.error_message);
  ...
  useEffect(() => {
    if (backendValidations) {
      ...
      const usernameTakenLabel = formatMessage(messages['registration.robbo.username.taken_error']);
      ...
      if (localizedValidations.username) {
        localizedValidations.username = normalizeUsernameServerErrorMessage(
          localizedValidations.username,
          usernameTakenLabel,
        );
      }
            ...
            <Form id="registration-form" name="registration-form" onSubmit={handleSubmit}>
              ...
              {companyFieldData && (
                <FormFieldRenderer
                  ...
                  isRequired={companyFieldRequired}
                />
              )}
              ...
              <ConfigurableRegistrationForm
                ...
                fieldErrors={registrationEmbedded ? temporaryErrors : errors}
